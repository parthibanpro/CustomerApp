...
import com.nasi.kandar.fairos.Helper.DatePickerHelper;
...
public class SetupActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
                    ...
                    if (task.isSuccessful()) {
                        ...
                        if (task.getResult().exists()) {
                           ...
                           // setupBtn.setEnabled(false);
                            ...
                            dob = task.getResult().getString("dob");
    ...
    private void sendToMain() {
        ...
        Intent mainIntent = new Intent(SetupActivity.this,FoodMenuActivity.class);
